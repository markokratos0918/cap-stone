     ...
     <h1 className="serviceMainTitle">TECHNOLOGY USED</h1>
          ...
          <Col style={{width:'50%', height:'300px'}} lg={6} md={12} sm={12}>
            <ResponsiveContainer>   
               ...
               <p className="text-justify serviceDescription">We are WD32P Group 4. We are web developers with a serious love for teaching I am a founder of eLe easy Learning and a passionate Web Developer, Programmer & Instructor.<br></br><br></br>
