          ...
          <Row>
            ...
            <Col lg={6} md={12} sm={12}>
              <p className="text-justify serviceDescription">
                We are WD32P Group 4. We are web developers with a serious love
                for teaching I am a founder of eLe JMFG Starlink Internet
                Solution Provider and a passionate Web Developer, Programmer &
                Instructor.<br></br>
